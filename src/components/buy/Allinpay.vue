        ...
        <div class="pop" v-show="showCode">
            <div class="code-box">
                ...
                <div class="code-con">
                    ...
                    <input type="number" v-model="code" placeholder="请输入验证码"><span class="code-get-btn" v-text="codeText"></span>
                    <div class="code-hint">验证码已发送至<span v-text="codePhone"></span>手机上</div>
                    <div class="code-enter-btn">确认</div>
                </div>
                <div class="code-bot">
...
.allinpay-wrap {
    ...
    .code-box{
        ...
        .code-con{
            ...
            .code-enter-btn{
                width:5.22rem;height:.89rem;color:#FFFFFF;font-size:.32rem;text-align:center;line-height:.89rem;background:url(../../../static/img/pay/code-btn-bg.png) no-repeat;background-size:5.22rem .89rem;border-radius: .02rem;margin:.8rem auto 0;
            }
        }
        .code-bot{
            margin-top:.6rem;
