    ...
    <div class="goods-details-wrap">
        ...
        <div class="goods-details-title">
            <div class="goods-datails-title-top">
                ...
                <div class="title-goods-type" v-if="detailData.deal_type == 1">租号</div>
            ...
            <div class="original-price"><span class="original-text">原价</span><span>￥</span><span v-text="detailData.goods_price"></span></div>
            <div class="goods-strip-bottom">
                ...
                <div>
                    <img src="../../../static/img/rent/pledge-ico.png" alt="">
                    <span>最短租期</span>
                    <span v-text="detailData.goods_price"></span><span>天</span>
                </div>
            </div>
            <div class="upTime">
                <span>发布时间：</span>
        ...
        <!-- 商品列表 -->
        <div v-if="recommendData != ''" class="recommend-list">
            <div class="goods-strip" v-for="item in recommendData" @click="goDetail(item.goods_id)">
                <div class="goods-strip-top">
                    <div class="goods-strip-title">
                        <div class="goods-type" v-if="item.deal_type == 1">租号</div>
        ...
        <div class="goods-details-bottom">
            ...
            <div class="rent-btn goods-details-bottom-right" @click="rentFn">立即租号</div>
                        ...
                        if (res.data.code == 200) {
                            ...
                            if (data == "") {
                                ...
                                if (that.detailData.goods_images != "") {
                                    ...
                                    img.push({
                                        img_url:
                                            "./static/img/goods-details/detail_img.png"
                                    });
